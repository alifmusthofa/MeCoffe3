    ...
    <div class="card-body">
        <div class="responsive">
            ...
            <nav class="navbar navbar-light  justify-content-between">
                ...
                <form class="form-inline" action="<?= base_url('admin/produk/search') ?>" method="post"
            ...
            <table class="table ml-1 mr-1 ">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td hidden><?= $p['id'] ?></td>
                        <td><img src="<?= base_url('assets/images/produk/' . $p['id'] . '/' . $p['gambar']); ?>"
                                width="50">
                        </td>
                        <td>
                        ...
                        <td style="width: 30%"><small><?= $p['deskripsi'] ?></small></td>
                        ...
                        <td>
                            <a href="<?= base_url('admin/produk/' . $p['id'] . '/preview') ?>"
                                class="btn btn-sm btn-outline-secondary" target="_blank">Preview</a>
                            <a href="<?= base_url('admin/produk/' . $p['id'] . '/edit') ?>"
                                class="btn btn-sm btn-outline-warning">Edit</a>
                            <a href="<?= base_url('admin/produk/' . $p['id'] . '/delete') ?>"
                                onclick="return confirm('Apakah kamu yakin akan menghapus produk <?= $p['nama'] ?> ?');"
