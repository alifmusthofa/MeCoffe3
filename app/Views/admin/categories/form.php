<div class="card">
    <div class="card-header">
        <h3 class="card-title"><?= isset($category) ? 'Update' : 'New' ?> Ukuran</h3>
    </div>
    <!-- /.card-header -->
    <!-- form start -->
    <?php if (!empty($category)) : ?>
        ...
        <?php else : ?>
            ...
            <!-- id kolom -->
            <input name="id" type="hidden" value="<?= isset($category->id) ? $category->id : null ?> " placeholder="id" />

            <!-- nama kolom -->
            <div class="card-body">
                <?= view('admin/Layout/flash_message') ?>
